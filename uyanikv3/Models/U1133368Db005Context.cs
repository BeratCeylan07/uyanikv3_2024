...
public partial class U1133368Db005Context : DbContext
{
    public U1133368Db005Context()
    {
    }

    public U1133368Db005Context(DbContextOptions<U1133368Db005Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseMySql("server=94.73.149.102;database=u1133368_db005;user=u1133368_user005;password=\"k5Wy=.04.Uyn0@EW\"", Microsoft.EntityFrameworkCore.ServerVersion.Parse("10.6.9-mariadb"));
